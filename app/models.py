...
class Student (models.Model):
    ...
    Scholarship = models.BooleanField(default=False, null=True)
    ...
    No_Dues_Certificate = models.BooleanField(default=False, null=True)
    Conduct = models.CharField(max_length=10, default=None, null=True)
    Signature_Of_HOD = models.BooleanField(default=False, null=True)
